...
export default class extends Controller {
  ...
  async lock() {
    ...
    try {
      ...
      this.showStatus(
        `Locked! <a href="${explorerUrl(signature, this.chainValue)}" target="_blank" class="underline">View on Explorer</a>`,
        "success"
      )
  ...
  async unlock(event) {
    ...
    try {
      ...
      this.showStatus(
        `Unlocked! <a href="${explorerUrl(signature, this.chainValue)}" target="_blank" class="underline">View on Explorer</a>`,
        "success"
      )
